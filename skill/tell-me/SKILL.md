---
name: tell-me
description: "告诉我（tell-me）本地离线文档问答工具。**强制要求**：只有当用户的问题以「告诉我」或「tell-me」开头时才能触发此技能。其他情况如提到「本地文档问答」、「离线问答」、「知识库问答」、「文档检索」等关键词但不以「告诉我」或「tell-me」开头的，不得触发此技能。"
---
...
- **触发条件**：**强制要求** - 用户的问题必须以「告诉我」或「tell-me」开头才能触发此技能，否则不得触发
